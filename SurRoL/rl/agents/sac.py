...
class SAC(BaseAgent):
    ...
    def update_critic(self, obs, action, reward, next_obs):
        ...
        self.critic_optimizer.zero_grad(set_to_none=True)  # set_to_none=True saves memory
        critic_loss.backward()
        self.critic_optimizer.step()
        
        # Detach intermediate tensors to free computation graph
        Q1 = Q1.detach()
        Q2 = Q2.detach()
    ...
    def update_actor_and_alpha(self, obs):
        ...
        # optimize actor loss
        self.actor_optimizer.zero_grad(set_to_none=True)  # set_to_none=True saves memory
        actor_loss.backward()
        ...
        # Detach to free computation graph
    ...
    def update(self, replay_buffer, demo_buffer):
        ...
        for i in range(self.update_epoch):
            ...
            # Aggressive memory cleanup every 5 updates
            if i % 5 == 0:
